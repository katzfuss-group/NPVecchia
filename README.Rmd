...
**Note**: if using an Anisotropic and/or non-stationary covariance, the ordering and/or neighborhood selection will not be optimal without accounting for it. Below the function for simply finding neighbors by spatial distance are the extensions for finding ordering and neighbors using the tapered sample covariance matrix (using correlation ordering).
