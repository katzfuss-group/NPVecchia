...
show(thetas_best)
#> $par
#> [1]  2.2719205 -2.1828707 -0.2930495
#> 
#> $value
#> [1] 28044.42
#> 
...
#> [1] "The KL-divergence for our method is 192.991579800824  while it is 285.462165216306 for the MLE."
```
...
#> [1] "The Frobenius norm for our method is 529.837703797619  while it is 808.747217795304 for the MLE."
```
